...
public class SourceTests
{
    ...
    public void SourceProperties_SetAndGetCorrectly()
    {
        ...
        CollectionAssert.AreEqual(new[] { "Author1", "Author2" }, source.Authors);
    ...
    {
        // Arrange
        var source = new Source { AuthorsString = "Author1|Author2" };

        // Act
        var authors = source.Authors;

        // Assert
        CollectionAssert.AreEqual(new[] { "Author1", "Author2" }, authors);
    }
