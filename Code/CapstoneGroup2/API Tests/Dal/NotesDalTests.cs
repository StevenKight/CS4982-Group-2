...
public class NotesDalTests
{
    ...
    public void GetAllNoteTest()
    {
        ...
        {
            Assert.AreEqual(this._notes[i].SourceId, result.ElementAt(i).SourceId);
            Assert.AreEqual(this._notes[i].Username, result.ElementAt(i).Username);
            Assert.AreEqual(this._notes[i].NoteText, result.ElementAt(i).NoteText);
            Assert.AreEqual(this._notes[i].TagsString, result.ElementAt(i).TagsString);
        }
    }
